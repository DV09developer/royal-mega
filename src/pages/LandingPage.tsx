...
export default function LandingPage() {
    return (
        <div className="mt-[50px] mx-auto w-[1398px]">
            <div className="relative">
                <img src="match_1.svg" alt="match image" />
                <div className="absolute top-[30px] left-[653px]">
                    <img src="ipl_logo.svg" alt="match image" />
                </div>
                <p className="text-[#FFFFFF] text-[24px] font-[400] absolute top-[88px] left-[561px]">
                    Upcoming IPL Showdown
                </p>
                <p className="text-[#FFFFFF] text-[32px] font-[600] absolute top-[390px] left-[380px]">
                    Next Match : April 24, 2026, 07:30 PM IST
                </p>
                <p className="text-[#FFFFFF] text-[24px] font-[400] absolute top-[426px] left-[490px]">
                    Narendramodi Stadium, Ahmedabad
                </p>
            </div>
            <p className="text-[#FFFFFF] text-[32px] font-[600] mt-[30px]">Upcoming Matches</p>
            <div className="flex gap-[20px] mt-[30px]">
                <div className="relative">
                    <img src="match_2.svg" alt="match image" />
                    <div className="absolute top-[12px] left-[321px]">
                        <img src="ipl_logo.svg" alt="match image" height={31} />
                    </div>
                    <p className="text-[#FFFFFF] text-[12px] font-[400] absolute top-[43px] left-[283px]">
                        Upcoming IPL Showdown
                    </p>
                    <p className="text-[#FFFFFF] text-[18px] font-[600] absolute top-[198px] left-[168px]">
                        Next Match : April 24, 2026, 07:30 PM IST
                    </p>
                    <p className="text-[#FFFFFF] text-[12px] font-[600] absolute top-[219px] left-[230px]">
                        Narendramodi Stadium, Ahmedabad
                    </p>
                </div>
                <div className="relative">
                    <img src="match_3.svg" alt="match image" />
                    <div className="absolute top-[12px] left-[321px]">
                        <img src="ipl_logo.svg" alt="match image" height={31} />
                    </div>
                    <p className="text-[#FFFFFF] text-[12px] font-[400] absolute top-[43px] left-[283px]">
                    ...
                    <p className="text-[#FFFFFF] text-[12px] font-[400] absolute top-[219px] left-[230px]">
                        Narendramodi Stadium, Ahmedabad
                    </p>
                </div>
            </div>
